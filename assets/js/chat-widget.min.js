(function () {
  ...
  style.innerHTML = `
    ...
    .zyekh-chat-btn-icon:hover {
      color: var(--text-main, #fafafa);
      border-color: var(--border-hover, #52525b);
      background: var(--bg-card, #141417) !important;
    }
  ...
  chatWindow.innerHTML = `
    <div class="zyekh-chat-header">
      ...
      <div class="zyekh-chat-header-actions">
        <button class="zyekh-chat-btn-icon" id="zyekhChatClear" title="Bersihkan Riwayat" aria-label="Bersihkan Riwayat">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path>
            <path d="M3 3v5h5"></path>
          </svg>
        </button>
        <button class="zyekh-chat-btn-icon" id="zyekhChatClose" title="Tutup Chat" aria-label="Tutup Chat">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
