...
- [ BACKLOG ] **GitHub Actions Automated CI QA Gate**: Workflow CI otomatis di GitHub Actions untuk memvalidasi `verify_batch.py` (15-axis) dan `check_emojis.py` pada setiap Pull Request/Commit (`.github/workflows/ci-qa-gate.yml`).
