...
When tasked with building UIs, AI models predictably fall into a toxic UX anti-pattern: **Oversizing everything**. AIs tend to generate massive paddings, giant fonts, and single-column vertical layouts. 

**Why this fails:** It wastes screen real estate, forces the user into endless scrolling, causes cognitive overload, and makes exploration exhausting.
...
## 2. THE ZYEKH.COM PHILOSOPHY: HIGH DENSITY & EFFORTLESS EXPLORATION
...
## 3. COMPONENT STANDARDIZATION (REUSABILITY)
...
**FINAL DIRECTIVE TO AI**: Before generating any new page or UI component, cross-reference your structural plan with this document. If your design requires excessive scrolling or introduces new inline CSS classes, **you have failed the assignment and must redesign it to be compact and grid-based.**
