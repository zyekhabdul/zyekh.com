...
- **AI Image Prompts**: Never specify cluttered title text or banner headers in image prompts. Use concise high-signal keywords (`3D isometric cyber architecture`) and let AI interpret composition.
